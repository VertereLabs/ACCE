                        ...
                        <div className="prose prose-invert max-w-none">
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-muted-foreground leading-relaxed mb-6">
                                    Goodwill is not amortised. Instead, it must be tested for impairment annually (or more frequently if there are indicators). The accounting depends on whether you chose the <strong className="text-foreground">Fair Value Method</strong> or the <strong className="text-foreground">Proportionate Share Method</strong> for NCI.
                                </p>
                                ...
                                <div className="grid md:grid-cols-2 gap-6 mb-6">
                                    <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-6">
                                        ...
                                        <div className="bg-card rounded-lg p-3 font-mono text-xs">
                                            ...
                                            <p className="mt-2 text-muted-foreground italic">*Loss split in AOE between Parent/NCI</p>
                                        </div>
                                    </div>
                                    <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-6">
                                        ...
                                        <div className="bg-card rounded-lg p-3 font-mono text-xs">
                                            <p className="m-0">Dr Impairment Loss (P/L)</p>
                                            <p className="m-0 text-accent">Cr Goodwill (SOFP)</p>
                                            <p className="mt-2 text-muted-foreground italic">*Loss fully allocated to Parent in AOE</p>
                                        </div>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section className="mb-12">
                                ...
                                <div className="space-y-4 mb-6">
                                    <div className="bg-card border border-border rounded-xl p-6 flex gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-display font-semibold text-foreground mb-1">1. Unrealised Profit</h4>
                                            <p className="text-muted-foreground text-sm m-0">The profit on the sale is unrealised from the group&apos;s perspective until the asset is depreciated or sold outside the group.</p>
                                        </div>
                                    </div>
                                    <div className="bg-card border border-border rounded-xl p-6 flex gap-4">
                                        <RefreshCw className="w-6 h-6 text-blue-500 flex-shrink-0" />
                                        <div>
                                            <h4 className="font-display font-semibold text-foreground mb-1">2. Excess Depreciation</h4>
                                            <p className="text-muted-foreground text-sm m-0">The buyer depreciates the asset at its new (higher) cost. This &quot;excess&quot; depreciation must be reversed to bring the asset back to its original group carrying amount.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-muted-foreground leading-relaxed mb-6">
                                    This is a major exam topic. The accounting depends entirely on whether <strong className="text-foreground">control</strong> is maintained or lost.
                                </p>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-6">
                                        ...
                                        <p className="text-muted-foreground text-sm mb-4">
                                            This is viewed as an <strong className="text-foreground">equity transaction</strong>. No gain or loss is recognized in Profit or Loss.
                                        </p>
                                    ...
                                    <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-6">
                                        ...
                                        <ol className="space-y-2 text-xs text-muted-foreground list-decimal ml-4 p-0">
                                            ...
                                            <li>Remeasure any retained interest (the 40%) to <strong className="text-foreground">Fair Value</strong>.</li>
                                            <li>Recognize the gain or loss in <strong className="text-foreground">Profit or Loss</strong>.</li>
                                        </ol>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-muted-foreground leading-relaxed mb-6">
                                    When you have a foreign subsidiary, you must translate its financial statements into the group&apos;s presentation currency. This gives rise to the <strong className="text-foreground">Foreign Currency Translation Reserve (FCTR)</strong>.
                                </p>
                                ...
                                <div className="bg-accent/10 border border-accent/30 rounded-xl p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <p className="text-muted-foreground m-0 text-sm">
                                            <strong className="text-foreground">Pro-Tip:</strong> The difference resulting from these different rates is recognized in <strong className="text-foreground">Other Comprehensive Income (OCI)</strong> and accumulated in the FCTR in equity. On disposal of the sub, this reserve is &quot;recycled&quot; to Profit or Loss.
                                        </p>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section className="mb-12">
                                ...
                                <div className="bg-card rounded-xl border border-border p-6 text-sm">
                                    <p className="text-muted-foreground mb-4">To master these complex topics, always focus on:</p>
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-muted-foreground mb-6">
                                    We&apos;ll look at <strong className="text-foreground">Associates and Joint Ventures</strong>. You&apos;ll learn when to use the equity method instead of consolidation and how to work through the investment in associate working paper.
                                </p>
                            </section>
                        </div>
