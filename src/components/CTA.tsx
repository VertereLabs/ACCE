    ...
    return (
        <section id="contact" className="py-24">
            <div className="container mx-auto px-6">
                <div className="relative overflow-hidden rounded-3xl bg-white/10 backdrop-blur-md border border-white/20 p-12 md:p-20">
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-xl text-primary-foreground/70 mb-8 max-w-xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
                            ...
                            <Button
                                size="lg"
                                variant="outline"
                                className="border-2 border-white/30 text-primary-foreground bg-transparent hover:bg-white/10"
                                asChild
                            >
