                ...
                <div className="container mx-auto px-6">
                    ...
                    <article className="max-w-4xl">
                        ...
                        <header className="mb-12">
                            ...
                            <h1 className="font-display text-3xl md:text-4xl font-bold text-primary-foreground mb-4 text-balance">
                        ...
                        <div className="prose prose-invert max-w-none">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-5 gap-2 mb-12">
                                {[
                                    ...
                                    <div key={s.step} className="p-3 bg-white/5 border border-white/10 rounded-lg text-center">
                                        <div className="text-accent font-bold text-xs mb-1">STEP {s.step}</div>
                                        <div className="text-[10px] text-primary-foreground leading-tight">{s.title}</div>
                                    </div>
                                ))}
                            </div>
                            ...
                            <section className="mb-12">
                                ...
                                <ul className="space-y-3 bg-white/5 border border-white/10 rounded-xl p-6 mb-6 list-none m-0 shadow-inner">
                                    {[
                                ...
                                <div className="bg-accent/10 border border-accent/30 rounded-xl p-6 flex gap-4">
                                    ...
                                    <p className="text-sm text-primary-foreground/80 m-0">
                                        <strong className="text-primary-foreground italic">Collectability:</strong> You only look at the customer&apos;s <strong className="text-primary-foreground">ability and intention</strong> to pay. If it&apos;s not probable, you don&apos;t have a contract under IFRS 15.
                                    </p>
                                </div>
                            </section>
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/80 leading-relaxed mb-6">
                                    A PO is a promise to transfer a good or service. The key is determining if the goods/services are <strong className="text-primary-foreground">Distinct</strong>.
                                </p>
                                <div className="bg-white/5 border border-white/10 rounded-xl p-6 mb-6">
                                    <h4 className="font-bold text-primary-foreground mb-4">Criteria for a Distinct PO:</h4>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <div className="text-accent font-bold text-xs uppercase tracking-wider">A) Capability</div>
                                            <p className="text-sm text-primary-foreground/70">Customer can benefit from the good/service on its own or with other readily available resources.</p>
                                        </div>
                                        <div className="space-y-2">
                                            <div className="text-accent font-bold text-xs uppercase tracking-wider">B) Separately Identifiable</div>
                                            <p className="text-sm text-primary-foreground/70">The promise to transfer is distinct from other promises in the contract (not highly integrated or complexly interdependent).</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-6">
                                    <p className="text-sm text-primary-foreground/80 m-0 leading-relaxed">
                                        <strong className="text-primary-foreground">Common Example:</strong> A laptop (PO 1) and a 1-year software license (PO 2). They are distinct because the customer can use the laptop without the specific software and vice versa.
                                    </p>
                                </div>
                            </section>
                            ...
                            <section className="mb-12">
                                ...
                                <div className="grid sm:grid-cols-2 gap-4 text-sm mb-6">
                                    <div className="flex gap-3 p-4 bg-white/5 rounded-xl border border-white/10">
                                        ...
                                        <span><strong className="text-primary-foreground">Variable Consideration:</strong> Rebates, discounts, performance bonuses.</span>
                                    </div>
                                    <div className="flex gap-3 p-4 bg-white/5 rounded-xl border border-white/10">
                                        <Calculator className="w-5 h-5 text-accent flex-shrink-0" />
                                        <span><strong className="text-primary-foreground">Significant Financing:</strong> If payment is delayed by &gt;1 year.</span>
                                    </div>
                                    <div className="flex gap-3 p-4 bg-white/5 rounded-xl border border-white/10">
                                        <Split className="w-5 h-5 text-accent flex-shrink-0" />
                                        <span><strong className="text-primary-foreground">Non-cash Consideration:</strong> Measured at fair value.</span>
                                    </div>
                                    <div className="flex gap-3 p-4 bg-white/5 rounded-xl border border-white/10">
                                        <AlertCircle className="w-5 h-5 text-accent flex-shrink-0" />
                                        <span><strong className="text-primary-foreground">Consideration Payable:</strong> Payments made TO the customer.</span>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/80 leading-relaxed mb-6">
                                    If a contract has multiple POs, you must split the total price between them based on their <strong className="text-primary-foreground">Relative Stand-Alone Selling Prices (SASP)</strong>.
                                </p>
                                <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden mb-6">
                                    <div className="p-4 bg-accent/20 border-b border-white/10">
                                        <h4 className="font-bold text-accent text-xs uppercase tracking-widest text-center m-0">Allocation Example</h4>
                                    </div>
                                    <div className="p-6">
                                        <p className="text-xs text-primary-foreground/70 mb-4 italic">Total Bundle Price charged: R1,200</p>
                                        <table className="w-full text-xs text-left">
                                            <thead>
                                                <tr className="border-b border-white/10 text-primary-foreground/40 uppercase">
                                            ...
                                            <tbody className="text-primary-foreground/80">
                                                ...
                                                <tr className="border-t border-accent/30 bg-white/5 font-bold">
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/80 leading-relaxed mb-6">
                                    Revenue is recognized when (or as) the entity <strong className="text-primary-foreground text-lg">satisfies</strong> a PO by transferring control of the good or service.
                                </p>
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                        <h3 className="font-display text-lg font-semibold text-primary-foreground mb-4 flex items-center gap-2">
                                            <Unlock className="w-5 h-5 text-accent" />
                                            Over Time
                                        </h3>
                                        <p className="text-sm text-primary-foreground/70 mb-4">Recognize revenue as work progresses if ANY of these apply:</p>
                                        <ul className="text-xs text-primary-foreground/60 space-y-2 list-disc ml-4">
                                    ...
                                    <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                        ...
                                        <p className="text-sm text-primary-foreground/70 mb-4">If it doesn&apos;t meet &apos;Over Time&apos; criteria. Look for indicators of control transfer:</p>
                                        <ul className="text-xs text-primary-foreground/60 space-y-2 list-disc ml-4">
                            ...
                            {/* Summary & Next Steps */}
                            <section className="mb-12">
                                <h2 className="font-display text-2xl font-bold text-primary-foreground mb-4 border-t border-white/10 pt-12">
                                    Summary
                                </h2>
                                <div className="bg-accent/10 rounded-xl p-6">
                                    <p className="text-primary-foreground/80 leading-relaxed italic m-0">
