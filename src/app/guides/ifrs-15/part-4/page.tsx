            ...
            <main className="pt-32 pb-24">
                <div className="container mx-auto px-6">
                    ...
                    <article className="max-w-4xl">
                        ...
                        <div className="prose prose-invert max-w-none">
                            ...
                            <section className="mb-12">
                                ...
                                <div className="grid md:grid-cols-2 gap-6 mb-8">
                                    <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                        ...
                                        <p className="text-xs text-primary-foreground/70 mb-4 font-medium italic">Does it provide a service in addition to the assurance that the product complies with agreed specifications?</p>
                                        <div className="bg-blue-500/10 rounded-lg p-3 text-xs text-primary-foreground/80">
                                            <strong className="text-primary-foreground">ACCOUNTING:</strong> Not a separate PO. Account for under <strong className="text-primary-foreground">IAS 37</strong> (Provisions).
                                        </div>
                                    </div>
                                    <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                        ...
                                        <p className="text-xs text-primary-foreground/70 mb-4 font-medium italic">If the customer has the option to purchase the warranty separately, it&apos;s a separate PO.</p>
                                        <div className="bg-green-500/10 rounded-lg p-3 text-xs text-primary-foreground/80">
                                            <strong className="text-primary-foreground">ACCOUNTING:</strong> IS a <strong className="text-primary-foreground">Separate PO</strong>. Allocate part of the transaction price to it.
                                        </div>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/80 leading-relaxed mb-6">
                                    When another party is involved in providing goods or services, you must determine if you are the <strong className="text-primary-foreground underline decoration-accent decoration-2">Principal</strong> (Gross Revenue) or the <strong className="text-primary-foreground underline decoration-accent decoration-2">Agent</strong> (Net Commission).
                                </p>

                                <div className="bg-white/5 border border-white/10 rounded-xl p-6 mb-6">
                                    <h4 className="font-bold text-primary-foreground mb-4 text-sm flex items-center gap-2">
                            ...
                            <section className="mb-12">
                                ...
                                <div className="space-y-4">
                                    <div className="flex gap-4 p-5 bg-white/5 rounded-xl border border-white/10">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-primary-foreground mb-1 text-sm uppercase">Forward or Call Option</h4>
                                            <p className="text-xs text-primary-foreground/70 m-0 leading-relaxed">
                                                Customer does NOT have control. It&apos;s either a <strong className="text-primary-foreground">Lease</strong> (under IFRS 16) or a <strong className="text-primary-foreground">Financing Arrangement</strong>.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 p-5 bg-white/5 rounded-xl border border-white/10">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-primary-foreground mb-1 text-sm uppercase">Put Option</h4>
                                            <p className="text-xs text-primary-foreground/70 m-0 leading-relaxed">
                                                Entity repurchases at customer&apos;s request. Assessment depends on whether the customer has a <strong className="text-primary-foreground">significant economic incentive</strong> to exercise the option.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <section className="mb-12">
                                <div className="bg-accent/10 border border-accent/30 rounded-xl p-8">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-display text-xl font-bold text-primary-foreground mb-2">The &quot;Control&quot; Pivot</h3>
                                            <p className="text-primary-foreground/80 italic m-0 text-sm leading-relaxed">
                                                In all these complex cases, the answer always comes back to <strong className="text-primary-foreground underline decoration-accent decoration-2 underline-offset-4">Control</strong>. If the customer hasn&apos;t gained the ability to direct the use of and obtain substantially all remaining benefits from the asset, you cannot recognize revenue.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="max-w-4xl mt-16">
                        <div className="bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 p-8 text-center text-balance">
