                ...
                <div className="container mx-auto px-6">
                        ...
                        <div className="prose prose-invert max-w-none">
                            ...
                            <section className="mb-12">
                                ...
                                <div className="bg-white/5 border border-white/10 rounded-xl p-6 mb-6">
                                    <h3 className="font-display text-lg font-semibold text-primary-foreground mb-4">What changed?</h3>
                                    <ul className="space-y-3 text-sm text-primary-foreground/70 list-none p-0 m-0">
                                        <li className="flex items-start gap-2">
                                            <CheckCircle2 className="w-4 h-4 text-accent mt-0.5" />
                                            <span><strong className="text-primary-foreground">Consistency:</strong> One five-step model for everyone.</span>
                                        </li>
                                        <li className="flex items-start gap-2">
                                            <CheckCircle2 className="w-4 h-4 text-accent mt-0.5" />
                                            <span><strong className="text-primary-foreground">Better Disclosure:</strong> Investors get more detail on the &quot;unearned&quot; revenue and contract assets.</span>
                                        </li>
                                        <li className="flex items-start gap-2">
                                            <CheckCircle2 className="w-4 h-4 text-accent mt-0.5" />
                                            <span><strong className="text-primary-foreground">Allocation:</strong> Clear rules for how to split the price between a &quot;free&quot; handset and a monthly service.</span>
                                        </li>
                                    </ul>
                                </div>
                            </section>
                            ...
                            <section className="mb-12">
                                ...
                                <div className="bg-accent/10 border border-accent/30 rounded-2xl p-8 mb-6">
                                    <p className="text-xl font-display font-medium text-primary-foreground leading-relaxed m-0 text-center italic">
                                ...
                                <p className="text-primary-foreground/70 text-sm italic text-center">
                                    — IFRS 15.2
                                </p>
                            </section>
                            ...
                            <section className="mb-12">
                                ...
                                <div className="grid sm:grid-cols-2 gap-4 mb-6">
                                    <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                                        ...
                                        <p className="text-xs text-primary-foreground/60">IFRS 16 (Leases) takes precedence here.</p>
                                    </div>
                                    <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                                        <h4 className="font-bold text-blue-400 mb-1">Insurance Contracts</h4>
                                        <p className="text-xs text-primary-foreground/60">Governed by IFRS 17.</p>
                                    </div>
                                    <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                                        <h4 className="font-bold text-purple-400 mb-1">Financial Instruments</h4>
                                        <p className="text-xs text-primary-foreground/60">IFRS 9 handles interest and dividends.</p>
                                    </div>
                                    <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                                        <h4 className="font-bold text-accent mb-1">Non-Monetary Exchanges</h4>
                                        <p className="text-xs text-primary-foreground/60">Between entities in the same line of business.</p>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section className="mb-12">
                                ...
                                <div className="space-y-4">
                                    <div className="flex gap-4 p-5 bg-white/5 rounded-xl border border-white/10">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-primary-foreground mb-1 text-sm">Customer</h4>
                                            <p className="text-sm text-primary-foreground/70 m-0">A party that has contracted with an entity to obtain goods or services that are an output of the entity&apos;s ordinary activities.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 p-5 bg-white/5 rounded-xl border border-white/10">
                                        <Receipt className="w-6 h-6 text-accent flex-shrink-0" />
                                        <div>
                                            <h4 className="font-bold text-primary-foreground mb-1 text-sm">Income vs Revenue</h4>
                                            <p className="text-sm text-primary-foreground/70 m-0">Income is the broad category. <strong className="text-primary-foreground">Revenue</strong> is specifically income arising in the course of an entity&apos;s <strong className="text-primary-foreground">ordinary activities</strong>.</p>
                                        </div>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/70 mb-8">
                                    Now that we have the foundations, we can dive into the heart of IFRS 15: the <strong className="text-primary-foreground">Five-Step Model</strong>. This model is what you will apply in every single exam question.
                                </p>

                                <div className="bg-white/5 border border-white/10 rounded-xl p-8 text-center">
                                    <Target className="w-12 h-12 text-accent mx-auto mb-4" />
                                    <h3 className="font-display text-xl font-bold text-primary-foreground mb-2">Ready for the Deep Dive?</h3>
                                    <p className="text-primary-foreground/60 mb-6 max-w-sm mx-auto">
                    ...
                    <div className="max-w-4xl mt-16">
                        <div className="bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 p-8 text-center">
                            ...
                            <Button asChild variant="outline" className="border-white/20 hover:bg-white/10 text-primary-foreground">
