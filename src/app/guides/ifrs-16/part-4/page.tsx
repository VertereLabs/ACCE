                ...
                <div className="container mx-auto px-6">
                        ...
                        <div className="prose prose-invert max-w-none">
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/80 leading-relaxed mb-6">
                                    You must check if the transfer of the asset is a &quot;sale&quot; according to <strong className="text-primary-foreground font-bold">IFRS 15</strong> (Revenue from Contracts with Customers).
                                </p>
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-6">
                                        ...
                                        <p className="text-xs text-primary-foreground/70 m-0">The &quot;seller-lessee&quot; continues to recognize the asset and accounts for the proceeds as a <strong className="text-primary-foreground">Financial Liability</strong> (essentially a loan).</p>
                                    </div>
                                    <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-6">
                                        ...
                                        <p className="text-xs text-primary-foreground/70 m-0">Account for the transaction as a sale and a leaseback using the ROU model.</p>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/80 leading-relaxed mb-6 font-medium italic">
                                    The key trick here: You do NOT recognize the full gain on the sale.
                                </p>

                                <div className="space-y-6">
                                    <div className="p-6 bg-white/5 border border-white/10 rounded-xl">
                                        <h4 className="font-bold text-primary-foreground mb-4 text-xs uppercase tracking-widest text-accent">Calculation Roadmap:</h4>
                                        <ol className="text-sm text-primary-foreground/70 space-y-4 m-0 p-0 list-decimal ml-4">
                                            <li>
                                                <strong className="text-primary-foreground">ROU Asset:</strong> Previous carrying amount × (Lease Liability ÷ Fair Value of Asset).
                                            </li>
                                            <li>
                                                <strong className="text-primary-foreground">Gain on Sale:</strong> Full Gain × ([Fair Value - Lease Liability] ÷ Fair Value).
                                            </li>
                                        </ol>
                                    </div>
                                    ...
                                    <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-6 flex gap-4">
                                        ...
                                        <p className="text-xs text-primary-foreground/80 m-0 leading-relaxed">
                                            We only recognize the gain that relates to the <strong className="text-primary-foreground">Rights Transferred</strong> to the buyer-lessor. The portion of the gain relating to the right to use the asset that we&apos;ve kept is offset against the ROU asset.
                                        </p>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section className="mb-12">
                                ...
                                <ul className="space-y-3 p-0 m-0 list-none">
                                    <li className="flex gap-3 p-4 bg-white/5 rounded-xl border border-white/10 text-xs">
                                        <Repeat className="w-4 h-4 text-accent flex-shrink-0" />
                                        <span><strong className="text-primary-foreground uppercase">Below Market:</strong> Account for as a prepayment of lease payments.</span>
                                    </li>
                                    <li className="flex gap-3 p-4 bg-white/5 rounded-xl border border-white/10 text-xs">
                                        <Repeat className="w-4 h-4 text-accent flex-shrink-0" />
                                        <span><strong className="text-primary-foreground uppercase">Above Market:</strong> Account for as additional financing provided by the buyer-lessor to the seller-lessee.</span>
                                    </li>
                                </ul>
                            </section>
                            ...
                            <section className="mb-12">
                                <div className="bg-white/5 border border-white/10 rounded-xl p-8">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-display text-xl font-bold text-primary-foreground mb-2">Exam Hack: Total Sanity Check</h3>
                                            <p className="text-sm text-primary-foreground/80 m-0 leading-relaxed italic">
                                                In a Sale and Leaseback, your <strong className="text-primary-foreground">ROU Asset</strong> and your <strong className="text-primary-foreground">Gain on Sale</strong> are always linked. If one is wrong, both are wrong. Use the formula:
                                                <br />
                    ...
                    <div className="max-w-4xl mt-16">
                        <div className="bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 p-8 text-center">
                            ...
                            <p className="text-primary-foreground/70 mb-6 leading-relaxed max-w-lg mx-auto">
