                        ...
                        <div className="prose prose-invert max-w-none">
                            ...
                            <div className="bg-white/5 rounded-2xl border border-white/10 p-8 mb-10">
                                <p className="text-primary-foreground/80 text-lg leading-relaxed m-0">
                                    The <strong className="text-primary-foreground">Analysis of Equity (AOE)</strong> is the single most important working paper in group accounting. It is the &quot;engine room&quot; where you calculate the figures that populate your consolidation journals and financial statements. Master the AOE, and you master Groups.
                                </p>
                            </div>
                                ...
                                <div className="bg-accent/10 border border-accent/30 rounded-xl p-6 mb-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <p className="text-primary-foreground/80 m-0">
                                            Always work in the <strong className="text-primary-foreground">100% column</strong> first. Only once you have calculated the total movement for a period do you split it between the Parent and the Non-Controlling Interest (NCI).
                                        </p>
                                    </div>
                                </div>
                            ...
                            <section className="mb-12">
                                ...
                                <div className="bg-white/5 rounded-xl border border-white/10 overflow-hidden mb-6">
                                    <div className="overflow-x-auto">
                                        <table className="w-full text-xs text-left border-collapse">
                                            <thead>
                                                <tr className="bg-white/10 text-primary-foreground">
                                                    <th className="p-3 border-b border-white/10">Description</th>
                                                    <th className="p-3 border-b border-white/10 border-l border-white/10">Total (100%)</th>
                                                    <th className="p-3 border-b border-white/10 border-l border-white/10">Parent (x%)</th>
                                                    <th className="p-3 border-b border-white/10 border-l border-white/10">NCI (y%)</th>
                                                </tr>
                                            </thead>
                                            <tbody className="text-primary-foreground/70">
                                                <tr className="bg-blue-500/5">
                                                    <td className="p-3 border-b border-white/5 font-semibold text-blue-400">AT ACQUISITION</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                </tr>
                                                <tr>
                                                    <td className="p-3 border-b border-white/5">Share Capital</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10">X</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                </tr>
                                                <tr>
                                                    <td className="p-3 border-b border-white/5">Retained Earnings (at acq)</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10">X</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                </tr>
                                                <tr>
                                                    <td className="p-3 border-b border-white/5">FV Adjustments (Net of Tax)</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10">X</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                </tr>
                                                <tr className="bg-blue-500/10 font-bold">
                                                    <td className="p-3 border-b border-white/5">At Acquisition Equity</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10">NAV</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10">Split</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10">Split</td>
                                                </tr>
                                                <tr className="bg-accent/5">
                                                    <td className="p-3 border-b border-white/5 font-semibold text-accent">SINCE ACQUISITION (Pre-CY)</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                </tr>
                                                <tr>
                                                    <td className="p-3 border-b border-white/5">Movement in Retained Earnings</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10">X</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                </tr>
                                                <tr>
                                                    <td className="p-3 border-b border-white/5">Depreciation on FV Adj (Pre-CY)</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10">(X)</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                </tr>
                                                <tr className="bg-accent/10 font-bold">
                                                    <td className="p-3 border-b border-white/5">Total Since Acquisition</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10">Total</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10">Split</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10">Split</td>
                                                </tr>
                                                <tr className="bg-green-500/5">
                                                    <td className="p-3 border-b border-white/5 font-semibold text-green-400">CURRENT YEAR</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                </tr>
                                                <tr>
                                                    <td className="p-3 border-b border-white/5">Profit for the Year</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10">X</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                </tr>
                                                <tr>
                                                    <td className="p-3 border-b border-white/5">Current Year Depreciation on FV Adj</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10">(X)</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10"></td>
                                                </tr>
                                                <tr className="bg-green-500/10 font-bold">
                                                    <td className="p-3 border-b border-white/5">Total Current Year</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10">Total</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10">Split</td>
                                                    <td className="p-3 border-b border-white/5 border-l border-white/10">Split</td>
                                                </tr>
                                ...
                                <p className="text-primary-foreground/50 text-xs text-center italic">
                            ...
                            <section className="mb-12">
                                ...
                                <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-6 mb-6">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4">
                                        <div className="bg-white/5 rounded-lg p-4">
                                            <h4 className="text-primary-foreground font-semibold mb-2">Use / Normal Recovery</h4>
                                            <p className="text-primary-foreground/60 text-sm m-0">
                                                Rate: <strong className="text-primary-foreground">27%</strong> (Current rate)<br />
                                                Applies to: Inventory, Depreciable PPE, Provisions.
                                            </p>
                                        </div>
                                        <div className="bg-white/5 rounded-lg p-4">
                                            <h4 className="text-primary-foreground font-semibold mb-2">Sale / CGT Recovery</h4>
                                            <p className="text-primary-foreground/60 text-sm m-0">
                                                Rate: <strong className="text-primary-foreground">21.6%</strong> (27% x 80% inclusion)<br />
                                ...
                                <div className="bg-white/5 rounded-xl border border-white/10 p-6">
                                    ...
                                    <div className="bg-white/5 rounded-lg p-4 font-mono text-xs space-y-2">
                                        <p className="text-primary-foreground">FV Adj (PPE) = FV - Cost</p>
                                        <p className="text-primary-foreground font-bold">Deferred Tax = FV Adj x 27%</p>
                                        <p className="text-accent">Net FV Adj = FV Adj - Deferred Tax</p>
                                    </div>
                                    <p className="text-primary-foreground/60 text-sm mt-4 italic">
                            ...
                            <section className="mb-12">
                                ...
                                <div className="grid md:grid-cols-2 gap-6 mb-6">
                                    <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                        ...
                                        <p className="text-primary-foreground/70 text-sm m-0">
                                            Goes to <strong className="text-primary-foreground">Group Retained Earnings</strong> or SOCIE. This represents the parent&apos;s portion of the subsidiary&apos;s growth.
                                        </p>
                                    </div>
                                    <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                        <h3 className="font-display text-lg font-semibold text-primary-foreground mb-2">
                                        ...
                                        <p className="text-primary-foreground/70 text-sm m-0">
                                            Goes to the <strong className="text-primary-foreground">NCI line in Equity</strong> on the SOFP. This represents the minority shareholders&apos; portion of the subsidiary&apos;s equity.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="bg-accent/10 border border-accent/30 rounded-xl p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-display font-semibold text-primary-foreground mb-1">Important: Negative NCI</h4>
                            ...
                            <section className="mb-12">
                                ...
                                <div className="bg-white/5 rounded-xl border border-white/10 p-6">
                                    <ul className="space-y-4 m-0 p-0 list-none text-primary-foreground/80">
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/70 mb-6">
                                    We&apos;ll tackle <strong className="text-primary-foreground">Complex Transactions</strong>: step acquisitions, disposals (loss of control), FCTRs, and complex intra-group transfers of assets.
                                </p>
                            </section>
                        </div>
