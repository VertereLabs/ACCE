                        ...
                        <div className="prose prose-invert max-w-none">
                            ...
                            <div className="bg-white/5 rounded-2xl border border-white/10 p-8 mb-10">
                                <p className="text-primary-foreground/80 text-lg leading-relaxed m-0">
                                    IFRS 3 mandates the <strong className="text-primary-foreground">acquisition method</strong> for all business combinations. This part walks through each step — from identifying the acquirer to calculating goodwill. Get this right, and your consolidation journals will flow naturally.
                                </p>
                            </div>
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/80 leading-relaxed mb-6">
                                    The <strong className="text-primary-foreground">acquirer</strong> is the entity that obtains control of the acquiree. In most cases, this is straightforward — the entity paying cash or issuing shares is the acquirer. However, some situations require careful analysis:
                                </p>
                                ...
                                <div className="bg-accent/10 border border-accent/30 rounded-xl p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-display font-semibold text-primary-foreground mb-1">Reverse Acquisitions</h4>
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/80 leading-relaxed mb-6">
                                    The <strong className="text-primary-foreground">acquisition date</strong> is the date on which the acquirer obtains control of the acquiree. This is typically the closing date when:
                                </p>

                                <div className="grid md:grid-cols-2 gap-4 mb-6">
                                    <div className="bg-white/5 rounded-lg border border-white/10 p-4">
                                        <h4 className="text-primary-foreground font-semibold mb-2">Legal transfer occurs</h4>
                                        <p className="text-primary-foreground/60 text-sm m-0">
                                            Shares are transferred, consideration is paid
                                        </p>
                                    </div>
                                    <div className="bg-white/5 rounded-lg border border-white/10 p-4">
                                        <h4 className="text-primary-foreground font-semibold mb-2">Control is obtained</h4>
                                        <p className="text-primary-foreground/60 text-sm m-0">
                                ...
                                <div className="bg-accent/10 border border-accent/30 rounded-xl p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <p className="text-primary-foreground/80 m-0">
                                            <strong className="text-primary-foreground">Why it matters:</strong> All fair values are measured at the acquisition date. Pre-acquisition profits belong to the acquiree&apos;s previous owners; post-acquisition profits are included in the group&apos;s results.
                                        </p>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/80 leading-relaxed mb-6">
                                    At acquisition date, the acquirer recognizes the acquiree&apos;s identifiable assets and liabilities at their <strong className="text-primary-foreground">fair values</strong>. This includes items not previously recognized in the acquiree&apos;s books:
                                </p>
                                        ...
                                        <table className="w-full text-sm">
                                            <thead>
                                                <tr className="border-b border-white/10">
                                                    <th className="text-left py-2 text-primary-foreground">Item</th>
                                                    <th className="text-left py-2 text-primary-foreground">Measurement Basis</th>
                                                </tr>
                                            </thead>
                            ...
                            <section className="mb-12">
                                ...
                                <div className="grid md:grid-cols-2 gap-6 mb-6">
                                    <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-6">
                                        ...
                                        <div className="bg-white/5 rounded-lg p-3 text-sm">
                                            <p className="text-primary-foreground/60 m-0">
                                                <strong className="text-primary-foreground">Result:</strong> Goodwill includes both parent&apos;s and NCI&apos;s share
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-6">
                                        ...
                                        <div className="bg-white/5 rounded-lg p-3 text-sm">
                                            <p className="text-primary-foreground/60 m-0">
                                                <strong className="text-primary-foreground">Result:</strong> Goodwill only includes parent&apos;s share
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-accent/10 border border-accent/30 rounded-xl p-6">
                                    <div className="flex items-start gap-4">
                                        <Lightbulb className="w-6 h-6 text-accent flex-shrink-0 mt-0.5" />
                                        <p className="text-primary-foreground/80 m-0">
                                            <strong className="text-primary-foreground">Exam Tip:</strong> Always check which method the question requires. If not specified, state your assumption clearly. The fair value method gives higher goodwill but is more intuitive for impairment testing.
                                        </p>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section className="mb-12">
                                ...
                                <div className="bg-white/5 rounded-xl border border-white/10 p-6 mb-6">
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <h3 className="font-display text-lg font-semibold text-primary-foreground m-0">
                                            Goodwill Formula
                                        </h3>
                                    </div>
                                    <div className="bg-white/5 rounded-lg p-4 font-mono text-sm space-y-2">
                                        <p className="text-primary-foreground m-0">Goodwill = </p>
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4">
                                        <div className="bg-white/5 rounded-lg border border-white/10 p-4">
                                            <h4 className="text-primary-foreground font-medium mb-2">Cash</h4>
                                            <p className="text-primary-foreground/60 text-sm m-0">
                                                Amount paid at acquisition date
                                            </p>
                                        </div>
                                        <div className="bg-white/5 rounded-lg border border-white/10 p-4">
                                            <h4 className="text-primary-foreground font-medium mb-2">Shares Issued</h4>
                                            <p className="text-primary-foreground/60 text-sm m-0">
                                                Fair value (market price) at acquisition date
                                            </p>
                                        </div>
                                        <div className="bg-white/5 rounded-lg border border-white/10 p-4">
                                            <h4 className="text-primary-foreground font-medium mb-2">Contingent Consideration</h4>
                                            <p className="text-primary-foreground/60 text-sm m-0">
                                                Fair value at acquisition date (probability-weighted)
                                            </p>
                                        </div>
                                        <div className="bg-white/5 rounded-lg border border-white/10 p-4">
                                            <h4 className="text-primary-foreground font-medium mb-2">Deferred Consideration</h4>
                                            <p className="text-primary-foreground/60 text-sm m-0">
                                ...
                                <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-display font-semibold text-primary-foreground mb-1">Acquisition Costs</h4>
                                            <p className="text-primary-foreground/80 text-sm m-0">
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/80 leading-relaxed mb-6">
                                    If the fair value of net assets exceeds the consideration paid + NCI, you have a <strong className="text-primary-foreground">bargain purchase</strong>. Before recognizing a gain:
                                </p>
                                ...
                                <div className="bg-white/5 rounded-xl border border-white/10 p-6 mb-6">
                                    <ol className="space-y-3 m-0 p-0 list-none">
                                        ...
                                        <li className="flex items-start gap-3 text-primary-foreground/80">
                                            ...
                                            If confirmed, recognize the excess as a <strong className="text-primary-foreground">gain in profit or loss</strong>
                                        </li>
                                    </ol>
                                </div>
                                ...
                                <div className="bg-accent/10 border border-accent/30 rounded-xl p-6">
                                    <div className="flex items-start gap-4">
                                        <Lightbulb className="w-6 h-6 text-accent flex-shrink-0 mt-0.5" />
                                        <p className="text-primary-foreground/80 m-0">
                                            <strong className="text-primary-foreground">Common causes:</strong> Forced sales, distressed sellers, or errors in valuation. Bargain purchases are rare and examiners expect you to question them before recognizing a gain.
                                        </p>
                                    </div>
                                </div>
                            </section>
                                    ...
                                    <ul className="space-y-4 m-0 p-0 list-none">
                                        <li className="flex items-start gap-3">
                                            ...
                                            <span className="text-primary-foreground/80">
                                                <strong className="text-primary-foreground">Identify the acquirer:</strong> The entity obtaining control (power, returns, ability to affect returns).
                                            </span>
                                        </li>
                                        <li className="flex items-start gap-3">
                                            <CheckCircle2 className="w-5 h-5 text-accent flex-shrink-0 mt-0.5" />
                                            <span className="text-primary-foreground/80">
                                                <strong className="text-primary-foreground">Acquisition date:</strong> When control is obtained — all FVs measured at this date.
                                            </span>
                                        </li>
                                        <li className="flex items-start gap-3">
                                            <CheckCircle2 className="w-5 h-5 text-accent flex-shrink-0 mt-0.5" />
                                            <span className="text-primary-foreground/80">
                                                <strong className="text-primary-foreground">Fair value everything:</strong> Assets and liabilities at FV, with specific exceptions.
                                            </span>
                                        </li>
                                        <li className="flex items-start gap-3">
                                            <CheckCircle2 className="w-5 h-5 text-accent flex-shrink-0 mt-0.5" />
                                            <span className="text-primary-foreground/80">
                                                <strong className="text-primary-foreground">NCI choice:</strong> Fair value (full goodwill) or proportionate share (partial goodwill).
                                            </span>
                                        </li>
                                        <li className="flex items-start gap-3">
                                            <CheckCircle2 className="w-5 h-5 text-accent flex-shrink-0 mt-0.5" />
                                            <span className="text-primary-foreground/80">
                                                <strong className="text-primary-foreground">Expense acquisition costs:</strong> Legal/advisory fees hit P&L, not goodwill.
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/70 mb-6">
                                    We&apos;ll cover <strong className="text-primary-foreground">IFRS 10: Consolidation Mechanics</strong> — the procedures for combining parent and subsidiary, eliminating intra-group transactions, and presenting unified group financial statements.
                                </p>
                            </section>
                        </div>
