                        ...
                        <div className="prose prose-invert max-w-none">
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/80 leading-relaxed mb-6">
                                    Control is the cornerstone of consolidation. Under IFRS 10, an investor controls an investee when it has <strong className="text-primary-foreground">all three</strong> of the following:
                                </p>
                                ...
                                <div className="space-y-4 mb-6">
                                    <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-6">
                                        ...
                                        <p className="text-primary-foreground/80 text-sm m-0">
                                            Existing rights that give the investor the current ability to direct the <strong className="text-primary-foreground">relevant activities</strong> — the activities that significantly affect the investee&apos;s returns.
                                        </p>
                                    </div>
                                    ...
                                    <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-6">
                                        ...
                                        <p className="text-primary-foreground/80 text-sm m-0">
                                            Returns that can vary as a result of the investee&apos;s performance. This includes dividends, interest, fees, changes in investment value, and <strong className="text-primary-foreground">synergies</strong>. Returns can be positive, negative, or both.
                                        </p>
                                    </div>
                                ...
                                <div className="bg-accent/10 border border-accent/30 rounded-xl p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <p className="text-primary-foreground/80 m-0">
                                            <strong className="text-primary-foreground">Exam Tip:</strong> Control is assessed continuously. If circumstances change, you must reassess whether control still exists. Look for changes in voting rights, contractual arrangements, or board composition.
                                        </p>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section className="mb-12">
                                ...
                                <div className="bg-accent/10 border border-accent/30 rounded-xl p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-display font-semibold text-primary-foreground mb-1">Example</h4>
                                            <p className="text-primary-foreground/80 text-sm m-0">
                                                Company A holds 45% of Company B. The remaining 55% is held by thousands of small shareholders who rarely vote. Company A appoints the majority of the board and has historically controlled all shareholder votes. Company A likely has <strong className="text-primary-foreground">de facto control</strong>.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <section className="mb-12">
                                ...
                                <div className="bg-white/5 rounded-xl border border-white/10 p-6 mb-6">
                                    ...
                                    <ol className="space-y-4 m-0 p-0 list-none">
                                        <li className="flex items-start gap-4 text-primary-foreground/80">
                                            ...
                                            <div>
                                                <strong className="text-primary-foreground">Combine like items</strong> — Add together assets, liabilities, equity, income, and expenses line by line
                                            </div>
                                        </li>
                                        <li className="flex items-start gap-4 text-primary-foreground/80">
                                            ...
                                            <div>
                                                <strong className="text-primary-foreground">Eliminate parent&apos;s investment</strong> — Remove the parent&apos;s investment in subsidiary against subsidiary&apos;s equity
                                            </div>
                                        </li>
                                        <li className="flex items-start gap-4 text-primary-foreground/80">
                                            ...
                                            <div>
                                                <strong className="text-primary-foreground">Recognize goodwill or bargain purchase</strong> — Calculate and present on SOFP
                                            </div>
                                        </li>
                                        <li className="flex items-start gap-4 text-primary-foreground/80">
                                            ...
                                            <div>
                                                <strong className="text-primary-foreground">Eliminate intra-group transactions</strong> — Remove all intercompany balances, sales, dividends
                                            </div>
                                        </li>
                                        <li className="flex items-start gap-4 text-primary-foreground/80">
                                            ...
                                            <div>
                                                <strong className="text-primary-foreground">Recognize NCI</strong> — Present NCI in equity and allocate profit/loss
                                            </div>
                                        </li>
                                    </ol>
                                </div>
                                ...
                                <div className="bg-accent/10 border border-accent/30 rounded-xl p-6">
                                    <div className="flex items-start gap-4">
                                        <Lightbulb className="w-6 h-6 text-accent flex-shrink-0 mt-0.5" />
                                        <p className="text-primary-foreground/80 m-0">
                                            <strong className="text-primary-foreground">Remember:</strong> The consolidated financial statements present the parent and subsidiaries as a <strong>single economic entity</strong>. External transactions are shown; internal transactions are eliminated.
                                        </p>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/80 leading-relaxed mb-6">
                                    For consolidation, the parent and all subsidiaries must use <strong className="text-primary-foreground">uniform accounting policies</strong> for like transactions and events. If a subsidiary uses different policies:
                                </p>
                                ...
                                <div className="bg-white/5 rounded-xl border border-white/10 p-6">
                                    ...
                                    <ul className="space-y-2 m-0 p-0 list-none text-primary-foreground/80 text-sm">
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/80 leading-relaxed mb-6">
                                    All transactions <strong className="text-primary-foreground">between group entities</strong> must be eliminated in full. The consolidated statements should only show transactions with parties outside the group:
                                </p>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-white/5 rounded-xl border border-white/10 p-6">
                                        ...
                                        <div className="bg-white/5 rounded-lg p-4 font-mono text-sm">
                                            <p className="text-primary-foreground m-0">Dr Payable to parent (Sub&apos;s books)</p>
                                    ...
                                    <div className="bg-white/5 rounded-xl border border-white/10 p-6">
                                        ...
                                        <div className="bg-white/5 rounded-lg p-4 font-mono text-sm">
                                            <p className="text-primary-foreground m-0">Dr Revenue (Seller)</p>
                                    ...
                                    <div className="bg-accent/10 border border-accent/30 rounded-xl p-6">
                                        ...
                                        <p className="text-primary-foreground/80 text-sm mb-4">
                                            If goods sold between group companies are still held in inventory at year-end, the profit is <strong className="text-primary-foreground">unrealised</strong> and must be eliminated:
                                        </p>
                                        <div className="bg-white/5 rounded-lg p-4 font-mono text-sm">
                                            <p className="text-primary-foreground m-0">Dr Cost of sales / Retained earnings</p>
                                            <p className="text-accent ml-4 m-0">Cr Inventory</p>
                                        </div>
                                        <div className="mt-4 p-4 bg-white/5 rounded-lg">
                                            <p className="text-primary-foreground/70 text-xs m-0">
                                                <strong className="text-primary-foreground">Direction matters:</strong> For downstream sales (parent → sub), the full unrealised profit is eliminated from parent. For upstream sales (sub → parent), elimination is shared between parent and NCI.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-white/5 rounded-xl border border-white/10 p-6">
                                        ...
                                        <div className="bg-white/5 rounded-lg p-4 font-mono text-sm">
                                            <p className="text-primary-foreground m-0">Dr Dividend income (Parent&apos;s P/L)</p>
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/80 leading-relaxed mb-6">
                                    An <strong className="text-primary-foreground">investment entity</strong> does not consolidate its subsidiaries (except those providing services). Instead, it measures them at <strong className="text-primary-foreground">fair value through profit or loss</strong>.
                                </p>
                                ...
                                <div className="bg-accent/10 border border-accent/30 rounded-xl p-6">
                                    <div className="flex items-start gap-4">
                                        <Lightbulb className="w-6 h-6 text-accent flex-shrink-0 mt-0.5" />
                                        <p className="text-primary-foreground/80 m-0">
                                            <strong className="text-primary-foreground">Note:</strong> This exception is typically relevant for venture capital entities, private equity funds, and similar investment vehicles. For most exam questions involving operating subsidiaries, normal consolidation applies.
                                        </p>
                                    </div>
                                </div>
                            </section>
                                    ...
                                    <ul className="space-y-4 m-0 p-0 list-none">
                                        <li className="flex items-start gap-3">
                                            ...
                                            <span className="text-primary-foreground/80">
                                                <strong className="text-primary-foreground">Control = 3 elements:</strong> Power + variable returns + ability to affect returns.
                                            </span>
                                        </li>
                                        <li className="flex items-start gap-3">
                                            <CheckCircle2 className="w-5 h-5 text-accent flex-shrink-0 mt-0.5" />
                                            <span className="text-primary-foreground/80">
                                                <strong className="text-primary-foreground">De facto control:</strong> Control possible without majority voting rights.
                                            </span>
                                        </li>
                                        <li className="flex items-start gap-3">
                                            <CheckCircle2 className="w-5 h-5 text-accent flex-shrink-0 mt-0.5" />
                                            <span className="text-primary-foreground/80">
                                                <strong className="text-primary-foreground">Line-by-line:</strong> Combine all assets, liabilities, income, and expenses.
                                            </span>
                                        </li>
                                        <li className="flex items-start gap-3">
                                            <CheckCircle2 className="w-5 h-5 text-accent flex-shrink-0 mt-0.5" />
                                            <span className="text-primary-foreground/80">
                                                <strong className="text-primary-foreground">Uniform policies:</strong> Adjust for any differences before consolidating.
                                            </span>
                                        </li>
                                        <li className="flex items-start gap-3">
                                            <CheckCircle2 className="w-5 h-5 text-accent flex-shrink-0 mt-0.5" />
                                            <span className="text-primary-foreground/80">
                                                <strong className="text-primary-foreground">Eliminate everything internal:</strong> Balances, sales, profits, dividends.
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <section className="mb-12">
                                ...
                                <p className="text-primary-foreground/70 mb-6">
                                    We&apos;ll dive deep into the <strong className="text-primary-foreground">Analysis of Equity (AOE)</strong> — the heart of group accounting. You&apos;ll learn to work through at acquisition, since acquisition, and current year columns to derive all your consolidation journals.
                                </p>
                            </section>
                        </div>
